...
#define PIF ((PIF_TypeDef *)PIF_CTRL_BASE)
...
#define FB_STATUS_SHUT_DOWN 			((uint32_t)(0x00000004))
#define FB_STATUS_DEEP_SLEEP 			((uint32_t)(0x00000002))
#define FB_STATUS_ACTIVE 				((uint32_t)(0x00000001))
...
#define PAD_ENABLE                                                             \
	(PAD_E_4MA | PAD_P_PULLDOWN | PAD_OEN_NORMAL | PAD_SMT_DISABLE |       \
	 PAD_REN_DISABLE | PAD_SR_SLOW | PAD_CTRL_SEL_AO_REG)

#define PAD_DISABLE                                                            \
	(PAD_SMT_DISABLE | PAD_REN_DISABLE | PAD_SR_SLOW | PAD_E_4MA |         \
	 PAD_P_PULLDOWN | PAD_OEN_NORMAL | PAD_CTRL_SEL_AO_REG)

#define CFG_CTL_LOAD_ENABLE                                                    \
	(CFG_CTL_APB_CFG_WR | CFG_CTL_APB_WL_DIN | CFG_CTL_APB_BL_SEL |        \
	 CFG_CTL_APB_BLM_SEL | CFG_CTL_APB_BR_SEL | CFG_CTL_APB_BRM_SEL |      \
	 CFG_CTL_APB_TL_SEL | CFG_CTL_APB_TLM_SEL | CFG_CTL_APB_TR_SEL |       \
	 CFG_CTL_APB_TRM_SEL | CFG_CTL_APB_SEL_CFG)
